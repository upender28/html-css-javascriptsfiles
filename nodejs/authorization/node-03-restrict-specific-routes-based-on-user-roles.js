// Experiment 3: Restrict specific routes based on user roles.
// Aim: To demonstrate the above Node.js concept.
// Description: This program demonstrates restrict specific routes based on user roles using Node.js.
// Steps:
