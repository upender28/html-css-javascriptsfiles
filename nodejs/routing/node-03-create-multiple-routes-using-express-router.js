// Experiment 3: Create multiple routes using Express Router.
// Aim: To demonstrate the above Node.js concept.
// Description: This program demonstrates create multiple routes using express router using Node.js.
// Steps:
