// Experiment 1: Create a Node.js application using built-in modules.
// Aim: To demonstrate the above Node.js concept.
// Description: This program demonstrates create a node.js application using built-in modules using Node.js.
// Steps:
...
console.log('Node.js practical demonstration ready.');
console.log('Follow the comments above this program and run it with: node filename.js');
